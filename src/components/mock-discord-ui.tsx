...
import { PlusCircle, UserCircle, Inbox, Mic, Headphones, Cog, Menu, Phone, Video, Pin, UserCircle as UserCircleIcon, Search, Inbox as InboxIcon, HelpCircle, Gift, Sticker, Smile } from "lucide-react";
