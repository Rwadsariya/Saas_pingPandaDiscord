...
export const PaymentSuccessModel = () => {
    ...
    const isPaymentSuccess = data?.plan === "PRO"

    return <Modal showModal={isOpen} setShowModal={setIsOpen} onClose={handleClose}
        className="px-6 pt-6" preventDefaultClose={!isPaymentSuccess}
    >
        <div className="flex flex-col items-center">
            {isPending || !isPaymentSuccess ? <div className="flex flex-col items-center justify-center h-64">
