...
export const DashboardPageContent = () => {
    ...
    const { data: categories, isPending: isEventsCategoriesLoading } = useQuery({
                    ...
                    >
                        ...
                        <div className="relative p-6 z-10">
                            ...
                            <div className="flex items-center justify-between mt-4">
                                ...
                                <Button variant={"ghost"} size={"sm"} className="text-gray-500 hover:text-red-600 transition-colors"
