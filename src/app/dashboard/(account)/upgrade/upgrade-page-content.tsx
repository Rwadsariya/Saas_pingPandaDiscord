...
export const UpgradePageContent = ({ plan }: { plan: Plan }) => {
  ...
  return <div className="max-w-3xl flex flex-col gap-8">
    ...
    <p className="text-sm text-gray-500">
      Usage will reset{" "} {usageData?.resetDate ? (format(usageData.resetDate, "MMM d, yyyy")) : (<span className="animate-pulse w-8 h-4 bg-gray-200">

      </span>)}
      {plan !== "PRO" ? <span className=" inline cursor-pointer underline text-brand-600" onClick={() => createCheckoutSession()}>
