...
const Page = () => {
    ...
    const { mutate: createCheckoutSession } = useMutation({
        mutationFn: async () => {
            const res = client.payment.createCheckoutSession.$post()
    ...
    return <div className="bg-brand-25 py-24 sm:py-32">
        <MaxWidthWrapper>
            <div className="mx-auto max-2xl sm:text-center">
                <Heading className="text-center">
                    Simple no-tricks pricing
                </Heading>
                <p className="mt-6 text-base/7 text-gray-600 max-w-prose text-pretty text-center ">We hate subscriptions. And chances are, you do too. That&apos;s why we
                    offer lifetime access to PingPanda for a one-time payment.</p>
            </div>

            <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-8 lg:mx-0 lg:flex lg:max-w-none">
