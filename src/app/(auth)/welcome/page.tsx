...
const Page = () => {
    ...
    return (
        <div className="flex w-full flex-1 items-center justify-center px-4">
            <BackgroundPattern className="absolute inset-0 left-1/2 top-1/2 z-0 -translate-x-1/2 opacity-75 " />

            <div className="relative z-10 flex -translate-y-1/2 flex-col items-center gap-6 text-center">
                <LoadingSpinner size={"md"} />
                <Heading className="text-base/7 text-gray-600 max-w-prose">Creating your account...</Heading>
                <p>Just a moment please, we are setting up your account.</p>
            </div>
